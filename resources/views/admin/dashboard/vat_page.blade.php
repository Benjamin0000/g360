@extends('admin.layout', ['title'=>'VAT FEE'])
@section('content')
@php
  use Carbon\Carbon;
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
              <h5 class="card-title float-left">VAT Fee</h5>
              <br>
                <div class="">
                ...
                <div class="clear:right">
                    <h3 class="text-center">{{$cur.number_format($vat, 2, '.', ',')}}</h3>
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">DEBIT VAT FEE</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
        <form  action="{{route('admin.debitVat')}}" method="post">
