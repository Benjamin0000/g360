              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    ...
                    <p>Thanks for signing up at GetSupport360! We're excited to have you on board!</p>
                    <!-- Action -->
                      ...
                      <tr>
                        <td align="center">
                          <div>
                            ...
                            <a href="{{route('register.verify', [$token->token, $token->email])}}" class="button button--blue">Verify Email</a>
                          </div>
                        </td>
                      </tr>
                    </table>
                    <p>Thanks,<br>The GetSupport360 Team</p>
                    <!-- Sub copy -->
