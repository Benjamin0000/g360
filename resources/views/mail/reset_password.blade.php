        ...
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="email-masthead">
              <a class="email-masthead_name">GetSupport360</a>
            </td>
          </tr>
          <!-- Email Body -->
          <tr>
              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    ...
                    <p>A password reset request was initiated in your account.</p>
                    <!-- Action -->
                      ...
                      <tr>
                        <td align="center">
                          <div>
                            ...
                            <a href="{{route('pass.showUpdateForm', [$token->token, $token->email])}}" class="button button--blue">Change Password</a>
                          </div>
                        </td>
                      </tr>
                    </table>
                    <p>If you did not initiate this request just ignore this message.</p>
                    <!-- Sub copy -->
